...
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: ['manager', 'receptionist', 'housekeeping', 'security'], default: 'receptionist' }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.OneToMany)(() => invoice_entity_1.Invoice, (invoice) => invoice.staff),
    __metadata("design:type", Array)
